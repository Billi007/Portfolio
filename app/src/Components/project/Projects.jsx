...
const Projects = () => {
  return (
    <>
    <div className='text-black text-left flex justify-evenly items-center pt-10'>
     ...
     <h2 className='text-black font-extrabold text-3xl'>Projects</h2>
      ...
      <h1 className='text-black font-bold text-2xl'>MERN Chat app</h1>
      <div className='flex gap-1 text-[10px] my-5'>
...
User Authentication: Implemented secure login and registration using JWT authentication with cookies.</p>
     ...
     <img 
      className="w-[300px] h-[300px] bg-cover rounded-3xl max-w-sm mx-auto shadow-none transition-shadow cursor-pointer
     ...
     <div className='text-black text-left flex justify-evenly items-center pt-16'>
     
     <div className="w-[400px]">
      <p className='font-normal text-xs my-2'>FULL STACK DEVELOPER / TECH LEAD</p>
      
      <h1 className='text-black font-bold text-2xl'>Netflix app</h1>
