...
const Footer = () => {
  return (
    ...
    <div className="bg-[#0d171f] flex justify-evenly items-center text-[14px]">
     <h2 className="text-xl name">Tanishka Gupta</h2>
      <ul className="flex flex-col font-semibold text-[#ed6955] my-16 space-y-3">
        ...
        <ul className="flex flex-col font-semibold text-[#ed6955] my-10 space-y-3">
      ...
      <ul className="flex gap-4 text-2xl text-[#ed6955]">
        ...
        <li><a href='guptatanishka2008@gmail.com' className='hover:text-gray-400'> <MdEmail /></a></li>
      </ul>
      </div>
    </div>
    </>
